...
circosplot_EC_gene <- function(col.se='#9834eb', col.chip3='#f40000', col.chip2='#3acae0', col.chip1='#e0a33a', col.score.trans='#04cc65', col.score.cis='black', cex.se=0.7, geneplot=FALSE, maj.tick=1e9){
    ...
    # circos.genomicTrackPlotRegion(nodeScore.trans, ylim = c(0, 22), stack = FALSE, panel.fun = function(region, value, ...) {
...
load(paste0("/net/nwgc/vol1/sharing/Wei_Lab/USERS/tungch/tjongh/ec/test/anno_Rdata_B171_PC3ecRegion/",RUN,".annotChiaDrop.ecPol2.RData"))
message('Loading fragments from ', paste0("/net/nwgc/vol1/sharing/Wei_Lab/USERS/tungch/tjongh/ec/test/anno_Rdata_B171_PC3ecRegion/",RUN,".annotChiaDrop.ecPol2.RData"))
