...
##################
singularity run ./singularity/deeptools_3.3.2.sif computeMatrix \
...
singularity run ./singularity/deeptools_3.3.2.sif plotHeatmap -m PC3.chiadrop_med1_H3K27ac_5000.gz \
