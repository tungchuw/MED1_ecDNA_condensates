...
export hd_4a=${bwdir}${run1HD180}.${bwsuf}
...
${calcMatrix}/$pref.${RUN}.${FDR}.bed -S $mock1 $hd_1a $hd_2a $hd_3a $hd_4a -o $outMatfile
$deeptools plotHeatmap -m $outMatfile -o $pref.${RUN}.${FDR}.signal.${extbp}bp.heatmap.pdf --samplesLabel $run1Mock $run1HD30 $run1HD60 $run1HD120 $run1HD180 --whatToShow 'heatmap and colorbar' --regionsLabel "" --colorMap RdYlBu_r --zMax 8
