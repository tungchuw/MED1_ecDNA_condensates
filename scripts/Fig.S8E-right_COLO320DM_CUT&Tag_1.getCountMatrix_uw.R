...
maindir='/net/nwgc/vol1/nobackup/nocleanup/tungch/cut_tag/'
peakdir=paste0('/net/nwgc/vol1/nobackup/nocleanup/tungch/cut_tag/cleanPeaks/')
expset = 'C-n-T_AT4-48'
FDR = 0.01
peakfile_suf=paste0('.FDR',FDR,'_peaks.narrowPeak.noBL.narrowPeak')
